...
| Documento | Para quê |
|---|---|
| [TOOLS.md](TOOLS.md) | Referência das 59 tools (gerada do código) |
...
| [CLIENT_SETUP.md](CLIENT_SETUP.md) | Como conectar cada cliente e anexar arquivo pelo terminal (verificado em 23/09 e 25/09/2026) |
