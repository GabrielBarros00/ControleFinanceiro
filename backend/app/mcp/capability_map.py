...
ROTAS: dict[str, Rota] = {
    ...
    f"GET {W}/merchants": Rota("Estabelecimentos", ("categories_list",)),
    f"POST {W}/merchants": Rota("Criar estabelecimento", ("categories_create",), "kind=merchant"),
    f"PUT {W}/merchants/{{merchant_id}}": Rota("Editar estabelecimento", ("categories_update",), "kind=merchant"),
    f"DELETE {W}/merchants/{{merchant_id}}": Rota("Excluir estabelecimento", ("categories_update",), "kind=merchant, delete=true"),
    f"POST {W}/merchants/{{merchant_id}}/merge": Rota("Mesclar estabelecimentos", ("categories_update",), "kind=merchant, merge_into"),
    f"GET {W}/merchants/spending": Rota("Gasto por estabelecimento", ("reports_breakdown",), "group_by=merchant"),
...
FICHAS: dict[str, Ficha] = {
    ...
    "categories_list": Ficha("Vocabulário do espaço", "Category, Tag, Merchant", "baixo", "nenhum"),
    ...
    "categories_create": Ficha("Nome único por espaço; excluída é reativada (categoria, tag ou estabelecimento)", "commands.planning.create_category / create_tag, commands.merchants.create_merchant", "baixo", "WS"),
    "categories_update": Ficha("Nome único; tag e estabelecimento excluídos saem dos lançamentos; apelido de um só (0038)", "commands.planning.update_*/delete_*, commands.merchants", "médio — renomeia para todos", "WS"),
