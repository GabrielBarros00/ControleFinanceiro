...
ROTAS: dict[str, Rota] = {
    ...
    f"GET {API}/me/credit-cards/{{card_id}}/statements/{{statement_id}}": Rota("Detalhe da fatura", ("statements_get",)),
    ...
    f"GET {API}/me/overview": Rota("Visão do mês", ("reports_summary",)),
    ...
    f"GET {W}/transactions/{{transaction_id}}": Rota("Ver lançamento", ("transactions_get",)),
